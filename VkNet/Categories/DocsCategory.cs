...
namespace VkNet.Categories
{
    ...
    public partial class DocsCategory : IDocsCategory
    {
        ...
        ReadOnlyCollection<Document> IDocsCategory.GetById(IEnumerable<Document> docs)
        {
            throw new NotImplementedException();
        }

        ReadOnlyCollection<Attachment> IDocsCategory.Save(string file, string title, string tags)
        {
            throw new NotImplementedException();
        }

        ReadOnlyCollection<Attachment> IDocsCategory.Save(string file, string title, string tags, long? captchaSid, string captchaKey)
        {
            throw new NotImplementedException();
        }
    }

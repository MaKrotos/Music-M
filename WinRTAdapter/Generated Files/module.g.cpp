...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"NativeCode.PlayWithNumbers"))
    {
        return winrt_make_NativeCode_PlayWithNumbers();
    }

    if (requal(name, L"WinRTAdapter.DispatchAdapter"))
    {
        return winrt_make_WinRTAdapter_DispatchAdapter();
    }

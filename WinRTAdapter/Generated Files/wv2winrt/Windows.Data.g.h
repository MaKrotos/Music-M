...
{
struct Namespace_Windows_Data : winrt::implements<Namespace_Windows_Data, DispatchBase>
{
    public:
        Namespace_Windows_Data(const winrt::Microsoft::Web::WebView2::Core::ICoreWebView2DispatchAdapter& dispatchAdapter);
